                      ...
                      <td className={className}>
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            {/*  {email}*/}
                            {/*</Typography>*/}
                            {Object.keys(startMachine).map((machine) => (
                              <div
                                key={name + machine}
                                className={"scale-125 " + machine}
                              >
                          ...
                          {(t, { i18n }) => (
                            <Popover>
                              <PopoverHandler>
                                <div
                                  className={
                                    "w-15 h-15 scale-100 rounded-md p-1 shadow-sm ring-2 ring-amber-400 hover:ring-amber-100 dark:ring-amber-500 sm:scale-125 " +
                                    effectType +
                                    " xo-" +
                                    id
                                  }
                              ...
                              <PopoverContent className="w-96">
                                ...
                                <h5 className="font-bold text-blue-gray-800">
                      ...
                      <td className={className}>
                        {console.log(
                          colorMap[source]["color"] +
                            " w-16 text-center text-white font-bold text-sm py-2 px-3 rounded-lg",
                        )}
                        <div
                          className={
                            colorMap[source]["color"] +
